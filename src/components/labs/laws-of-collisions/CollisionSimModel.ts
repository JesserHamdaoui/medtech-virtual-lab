import { Elasticity, TimeSpeed } from "./types";
...
export class CollisionSimModel {
  ...
  public getIsMovingProperty() {
    return this.isMovingProperty;
  }

  public getTimeSpeedProperty() {
    return this.timeSpeedProperty;
  }

  public getElasticityProperty() {
    return this.elasticityProperty;
  }

  public getTimeElapsedProperty() {
    return this.timeElapsedProperty;
  }
  ...
  public updateBodyInitialVelocity(bodyIndex: number, newInitialVelocity: number) {
    const body = this.bodies[bodyIndex];
  ...
  public updateBodyInitialPosition(bodyIndex: number, newInitialPosition: number) {
    const body = this.bodies[bodyIndex];
  ...
  public update() {
    ...
    this.bodies.forEach((body) => {
      body.updateXPosition(body.position.x + body.velocity * timeStep * timeSpeed);
    });
